<?php
    ...
    if(isset($_POST['new'])){
        ...
        // sql queries
        $sql2 = "INSERT INTO gallery (image) VALUES ('$img')";
...
<body>
    ...
    <div class="all-page-title page-breadcrumb">
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Welcome To Gallery Section</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    <form method="post" enctype="multipart/form-data" >
                        <div class="form-group">
                            ...
                            <input type="file" name="file" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Full Name" required>
                        </div>
                        ...
                        <input type="submit" name="new" value="Add" class="btn btn-primary">
