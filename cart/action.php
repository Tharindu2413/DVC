...
if (isset($_POST['id'])) {
	...
	if (!$newname) {
		...
		$query = $con->prepare('INSERT INTO cart (name,price,image,qty,total_price) VALUES (?,?,?,?,?)');
		$query->bind_param('sssis', $name, $price, $image, $qty, $total_price);
		$query->execute();
...
if (isset($_POST['action']) && isset($_POST['action']) == 'order') {
	...
	$stmt->bind_param('ssssssss', $name, $email, $phone, $address, $pmode, $products, $grand_total);
	$stmt->execute();
