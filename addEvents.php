<?php
  ...
  $id = $_SESSION['id'];
    ...
    if(isset($_POST['new'])){
        ...
        if ($_FILES['file']['name']) {
            move_uploaded_file($_FILES['file']['tmp_name'], "./images/events/" . $_FILES['file']['name']);
            $img = "/" . $_FILES['file']['name'];
        }
        // sql queries
        $sql2 = "INSERT INTO events (name, description, price, qty, image,date) VALUES ('$name','$description','$price','$qty', '$img','$date' )";
...
<body>
    ...
    <div class="all-page-title page-breadcrumb">
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Welcome To New Event registration</h1>
                ...
                <div class="col-lg-12">
                    <form method="post" enctype="multipart/form-data" >
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Event Name" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Image" required>
                        </div>       
                        <!-- <button type="submit" class="btn btn-primary">Register</button> -->
                        <button type="submit" id="form-submit" name="new" class="btn btn-primary">Add New Event</button>
