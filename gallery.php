...
<head>
	...
	<!-- Site Metas -->
	<title>Gallery - CARS & COFFEE PALM BEACH</title>
                  ...
                  $result = mysqli_fetch_assoc($RES);
                        if ($result['usertype'] != 'Admin') {
						  ...
						  <?php } else {?>
							...
							<a href="./addGallery.php" class="btn btn-primary stretched-link">Add Gallery</a>
							<?php } ?>
				</div>
				</div>
			</div>
					...
					?>
						<div class="col-sm-12 col-md-4 col-lg-4">
							<a class="lightbox" href="images/gallery-img-01.jpg">
								<img class="img-fluid" src="./images/gallery/<?= $row['image'] ?>" alt="Gallery Images">
