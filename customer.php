    ...
    if(isset($_POST['new'])){
        ...
        if ($_FILES['file']['name']) {
            move_uploaded_file($_FILES['file']['tmp_name'], "./images/customers/" . $_FILES['file']['name']);
            $img = "/" . $_FILES['file']['name'];
        }
        // sql queries
        $sql1= "SELECT *  FROM users WHERE email='$email' or telephone='$telephone'";
        $sql2 = "INSERT INTO users (usertype, email, password, fullname, telephone, image) VALUES ('Customer', '$email','$hash','$fname', '$telephone', '$img' )";
...
<body>
    ...
    <div class="all-page-title page-breadcrumb">
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Welcome To Customer Registration Section</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    <form method="post" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="telephone" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Telephone" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="file" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" required>
                        </div>
                        <div class="form-group">
